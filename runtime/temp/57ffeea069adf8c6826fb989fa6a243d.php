<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\phpStudy\WWW\tp5\public/../application/admin\view\video\insert.html";i:1496656014;s:71:"D:\phpStudy\WWW\tp5\public/../application/admin\view\public\layout.html";i:1496730314;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="widget">
                ...
                <div class="widget-content">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row fileupload-buttonbar">
                            <div class="col-lg-7">
                                <div class="btn-toolbar" id="btn-toolbar">
                                    ...
                                    <span class="btn btn-success fileinput-button" style="position: relative" id="upload-video">
                                        <i class="icon-plus"></i>
                                        <span>开始上传</span>
                                    </span>
                                </div>
                        ...
                        <br>
                        <div class="progress progress-striped active contain" style="display: none">
                            <div class="progress-bar progress-bar-info uploadPro" role="progressbar"
...
<script src="/static/admin/js/jquery.js"></script>
<script src="/static/admin/js/plupload.full.min.js"></script>
<script src="/static/admin/js/qiniu.js"></script>
<script src="/static/admin/js/mine/video-upload.js"></script>
